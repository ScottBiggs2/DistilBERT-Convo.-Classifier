...
def main():
    ...
    parser.add_argument("--model-path", default="models/distilbert_distilled_alpha_0.0", 
                       help="Path to trained PyTorch model")
    parser.add_argument("--output-path", default="models/distilbert_distilled_alpha_0.0/quantized", 
