...
async def main():
    ...
    PYTORCH_MODEL_PATH = "models/distilbert_distilled_BERT_0.0_50_epochs"#"models/distilbert_distilled_alpha_0.0"
    ONNX_QUANTIZED_PATH = "models/distilbert_distilled_BERT_0.0_50_epochs/quantized/model.quant.onnx" #"models/distilbert_distilled_alpha_0.0/quantized/model.quant.onnx"
    OUTPUT_PATH = "eval/bert_comparison_results.json"
